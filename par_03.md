...
> 
> 1. Среди собственных чисел матрицы $$A$$ есть неотрицательные вещественные числа, и наибольшему из них $$\lambda(A)$$ соответствует неотрицательный собственный вектор $$\vec x_A$$ <br>
> 
>
> 2. Матрица $$(\rho E - A)$$ неотрицательно обратима (т.е. $$\exists (\rho E - A)^{-1}$$) $$\Leftrightarrow$$ $$\rho > \lambda(A)$$ <br>
>
> 
> 3. Если $$\vec y \geq 0$$, $$\vec y \neq 0$$ и $$a\vec y \geq \mu\vec y$$, то $$\mu \leq \lambda(A)$$ <br>
>
>

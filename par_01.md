...
* вектор $$\vec x$$ <i>неотрицательный</i> (<i>положительный</i>), если $$\forall i=1,\dots,n \hookrightarrow x_i \geq 0$$ ($$x_i > 0$$). Обозначим такое свойство как $$\vec x \geq 0$$ ($$\vec x > 0$$)

* матрица $$A = \| a_{ij} \|_{i,j=1}^n$$ <i>неотрицательная</i>, если $$\forall i,j = 1,\dots, n \hookrightarrow a_{ij} \geq 0$$. Обозначим как $$A \geq 0$$
